...
Μία εφαρμογή για παίκτες και για ρεσεψιόν στο γήπεδο (iPhone, iPad, Android). Η γραμματεία στο γραφείο μπορεί να δουλεύει και από browser στο laptop του club. Τα δεδομένα μένουν στο club. Δεν είναι εθνικό πρωτάθλημα.

**Τιμή Store:** Δωρεάν. Χωρίς in-app αγορά club.

**Μην γράψεις στο listing:** εφάπαξ ποσά, VPS, «δεν είναι απλό download», API, τιμές φροντίδας.
